#!/bin/bash
# H0-mini Joint OT (image_ot_targetbank_full), 5-fold
# 对应: brca_stage2_image_ot_targetbank_full_resnet50_g227_random5fold_bs64
set -e
DATE=$(date +%Y%m%d_%H%M%S)
BASE="/data/yujk/GLIP/experiments/h0mini_joint/h0mini_joint_ot_5fold_50ep_${DATE}"
